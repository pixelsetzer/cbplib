...
#define DPCR  0x20		// REG[20h] Display Configuration Register
#define FNCR0 0x21		// REG[21h] Font Control Register 0
#define FNCR1 0x22		// REG[22h] Font Control Register 1 
#define CGSR  0x23		// REG[23h] CGRAM Select Register
#define HOFS0 0x24
#define HOFS1 0x25
#define VOFS0 0x26
#define VOFS1 0x27
#define ROMS  0x28		// REG[28h] Font ROM Speed Setting

#define FLDR  0x29		// REG[29h] Font Line Distance Setting Register
...
#define MWCR0 0x40		// REG[40h] Memory Write Control Register 0
#define MWCR1 0x41		// REG[41h] Memory Write Control Register 1
#define TFCR  0x42		// REG[42h] Text Foreground Color Register
#define TBCR  0x43		// REG[43h] Text Background Color Register
#define BTCR  0x44		// REG[44h] Blink Time Control Register
#define CURS  0x45		// REG[45h] Text Cursor Size Register
#define CURH0 0x46		// REG[46h] Memory Write Cursor Horizontal Position Register 0
#define CURH1 0x47		// REG[47h] Memory Write Cursor Horizontal Position Register 1
#define CURV0 0x48		// REG[48h] Memory Write Cursor Vertical Position Register 0
#define CURV1 0x49		// REG[49h] Memory Write Cursor Vertical Position Register 1
#define RCURH0 0x4a		// REG[4Ah] Memory Read Cursor Horizontal Position Register 0
#define RCURH01 0x4b
#define RCURV0 0x4c
#define RCURV1 0x4d
#define MRCD  0x4e
...
// print text
void RAIO_print_text( uint16_t x, uint16_t y, unsigned char *text, uint16_t count, uint8_t BG_color, uint8_t FG_color );
