...
{
	//p.40  7 0=stop       1=start
	//      6 0=fullwindow 1=activewindow
	//      5-1: NA
	//      0: 0 Memory clear with BTE BG color 1: Memory clear with font BG color
	
	//      Reg 0x60, 0x61, 0x62 define BTE BG color (BGCR0=red, BGCR1=green, BGCR2=blue )
